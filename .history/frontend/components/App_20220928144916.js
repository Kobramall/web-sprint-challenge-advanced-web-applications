        ...
        <Routes>
          ...
          <Route element ={<PrivateRoute />}>
             <Route path="articles"  element ={
               <>
                 <ArticleForm getArticles={getArticles} isEditing={isEditing} setIsEditing={setIsEditing}/>
                 <Articles getArticles={getArticles} articles={articles} setIsEditing={setIsEditing} deleteArticle={deleteArticle}isEditing={isEditing}  />
               </>}/>
          </Route>
        </Routes>
